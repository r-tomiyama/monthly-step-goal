...
export const StepsLogo = (props: SvgIconProps) => {
  return (
    <SvgIcon {...props} viewBox="0 0 100 100">
      ...
      <g>
        {/* 左足 */}
        <ellipse cx="25" cy="30" rx="8" ry="12" fill="currentColor" opacity="0.8" />
        <ellipse cx="22" cy="45" rx="4" ry="6" fill="currentColor" opacity="0.8" />
        <ellipse cx="28" cy="45" rx="4" ry="6" fill="currentColor" opacity="0.8" />
        <ellipse cx="25" cy="55" rx="3" ry="4" fill="currentColor" opacity="0.8" />
        
        {/* 右足 */}
        <ellipse cx="50" cy="20" rx="8" ry="12" fill="currentColor" opacity="0.9" />
        <ellipse cx="47" cy="35" rx="4" ry="6" fill="currentColor" opacity="0.9" />
        <ellipse cx="53" cy="35" rx="4" ry="6" fill="currentColor" opacity="0.9" />
        <ellipse cx="50" cy="45" rx="3" ry="4" fill="currentColor" opacity="0.9" />
